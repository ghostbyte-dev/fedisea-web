...
const ServerCard = ({ instance, isLoading = false }: ServerCardProps) => {
  return (
    <>
      {isLoading && (
        <div className="bg-white rounded-xl shadow-sm border border-cyan-100 flex flex-col transition-all h-80"></div>
      )}
      {!isLoading && instance && (
        <Link
